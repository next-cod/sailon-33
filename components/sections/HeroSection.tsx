      ...
      <div className="container-shell relative grid items-center gap-14 lg:grid-cols-[.64fr_.46fr] lg:gap-20">
        <div>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-5">
            <TrackedLink href={siteLinks.signup} event="hero_signup_click" arrow className="min-w-[300px] !bg-[var(--signal)] !text-white">Попробовать бесплатно</TrackedLink>
            <a href="#demo" className="group inline-flex items-center gap-4 font-bold"><span className="grid size-[58px] place-items-center rounded-full border-2 border-[var(--forest-deep)] bg-white transition group-hover:bg-[var(--cream)]"><MessageCircle size={24}/></span>Поразговаривать с ботом</a>
          </div>
        </div>
        <HeroConsole />
      </div>

...
export function HeroConsole() {
  ...
  return (
    <motion.div animate={reduced ? undefined : { y: [0, -5, 0] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }} className="relative mx-auto w-full max-w-[490px] rounded-[24px] bg-white p-5 shadow-[0_12px_25px_rgba(0,0,0,.11)]">
